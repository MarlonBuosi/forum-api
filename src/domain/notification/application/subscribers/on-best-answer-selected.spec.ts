...
describe('On Best Answer Selected', () => {
  beforeEach(() => {
    ...
    new OnBestAnswerSelected(inMemoryAnswersRepository, sendNotificationUseCase)
  })
  it('should send a notification when a best answer is selected', async () => {
    const question = makeQuestion()
    const answer = makeAnswer({ questionId: question.id })

    console.log('AQUI', answer.id)
